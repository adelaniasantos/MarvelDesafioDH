...
public class Comics implements Parcelable {
    ...
    @Expose
    private ComicsImagem thumbnail;
    @Expose
    ...
    protected Comics(Parcel in) {
        ...
        thumbnail = in.readParcelable(ComicsImagem.class.getClassLoader());
        title = in.readString();
        upc = in.readString();
    ...
    public ComicsImagem getThumbnail() {
        return thumbnail;
    }

    public void setThumbnail(ComicsImagem thumbnail) {
